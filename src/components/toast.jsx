    ...
    >
        <div className="flex-1 w-0 p-4">
            <div className="flex items-start">
                <div className="flex-shrink-0 pt-0.5">
                    <img src='/images/checked.png' alt="Checked" className="h-[18px] w-[18px]" />
                </div>
        ...
        <div className="relative">
            <button
                ...
                className="w-[18px] h-[18px] absolute top-[-7px] left-[-10px] grid place-items-center rounded-full bg-white"
            >
...
export const error = (message = 'An error occurred') => toast.custom((t) => (
    ...
    >
        <div className="flex-1 w-0 p-4">
            <div className="flex items-start">
                <div className="flex-shrink-0 pt-0.5">
                    <img src='/images/close.png' alt="Checked" className="h-[18px] w-[18px]" />
                </div>
                <div className="ml-3 flex-1">
                    <p className="text-sm font-medium text-gray-900">
                        Error
